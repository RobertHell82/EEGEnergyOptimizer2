...
class AutoStatusSensor(_AutoSensor):
    ...
    def extra_state_attributes(self) -> dict[str, Any]:
        ...
        return {
            ...
            # Manueller Lade-/Entladetest — das Panel liest ihn hier ab,
            # damit die Statuskarte ohne eigenen Abruf mitläuft.
            "manuell_aktiv": st.get("manuell_aktiv"),
            "manuell_richtung": st.get("manuell_richtung"),
            "manuell_kw": st.get("manuell_kw"),
            "manuell_restsekunden": st.get("manuell_restsekunden"),
            "manuell_sollwert_w": st.get("manuell_sollwert_w"),
            "manuell_fehler": st.get("manuell_fehler"),
            "host": st.get("host"),
