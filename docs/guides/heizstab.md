...
> [!NOTE]
> **Das Fahrplan-Diagramm zeigt die voraussichtliche Puffertemperatur.** Im Ladestandsfeld läuft eine violette Linie mit: die gemessene Temperatur, fortgeschrieben mit der geplanten Wärme je Viertelstunde, gedeckelt an der Maximaltemperatur. Sie rechnet bewusst vorsichtig — mit dem Verlustaufschlag von 10 % und einem Bereitschaftsverlust von rund 0,12 kW an die Umgebung, bei 600 Litern gut 4 K am Tag. Was sie nicht kennt, ist die Zapfung: Warmwasser, das entnommen wird, und ein Heizkreis, der aus dem Puffer zieht, drücken die echte Temperatur schneller nach unten. Mit eingeblendetem Verlauf liegt der gemessene Wert dünn daneben. Die Optimierung selbst rechnet weiterhin nur mit Leistung und Tagesbudget; die Temperatur ist eine Nachrechnung für die Anzeige.
